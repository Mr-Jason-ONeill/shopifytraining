(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0660/2542/3075/t/3/assets/appstle-subscription.js?v=1681824647");
      ...
      RS.Config = {
        ...
        "shop": "unveil-restorative-hair-care.myshopify.com",
